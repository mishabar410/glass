...
class SttService {
    ...
    getPendingTranscript() {
        const meText = (this.myCompletionBuffer + (this.myCompletionBuffer && this.myCurrentUtterance ? ' ' : '') + this.myCurrentUtterance).trim();
        const themText = (this.theirCompletionBuffer + (this.theirCompletionBuffer && this.theirCurrentUtterance ? ' ' : '') + this.theirCurrentUtterance).trim();
    ...
    async initializeSttSessions(language = 'en') {
        ...
        const sttOptions = {
            ...
            model: this.modelInfo.model, // Pass selected STT model
            language: effectiveLanguage,
